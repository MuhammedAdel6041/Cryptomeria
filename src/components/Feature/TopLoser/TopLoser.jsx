...
import { FallOutlined, HomeOutlined } from "@ant-design/icons";
import Title from "antd/es/typography/Title";

function TopLoser({ simplified }) {
  ...
  return (
    <>
      ...
      {!simplified ? (
          <>
          <Title className="text-center p-4 m-4" level={1}> Top Loser Cryptocurrencies </Title>
