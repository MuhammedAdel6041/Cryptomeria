...
function Coins({ simplified }) {
    ...
    const { data: cryptoList, isFetching, error } = useGetCoinsQuery(count); // Use the correct hook
    ...
    return (
        <>
            ...
            {!simplified ? (
                <>
                <Title className="text-center p-4 m-4" level={1}> All  Cryptocurrencies </Title>
